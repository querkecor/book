	...
	<Script type="text/javascript">
		$(function (){
		    $("button.add").click(function (){
		        ...
		        // location.href = "http://localhost:8080/Book/cartServlet?action=addItem&id=" +itemId;

				$.getJSON("http://localhost:8080/Book/cartServlet","action=ajaxAddItem&id=" + itemId,function (data) {
		...
		<div id="book">
			...
			<div class="b_list">
				...
				<div class="book_info">
					...
					<div class="book_add">
						<button itemId="${book.id}" class="add">加入购物车</button>
					</div>
				</div>
			</div>
			</c:forEach>
